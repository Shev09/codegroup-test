...
import com.codegroup.javatest.exception.model.ErrorConstants;
...
public class ExceptionTranslator {
    ...
    @ExceptionHandler(NotFuncionarioException.class)
    @ResponseBody
    public ResponseEntity<ErrorDTO> processResourceNotFoundException(NotFuncionarioException ex) {
        log.error("Error: ", ex);
        ErrorDTO errorDTO = new ErrorDTO(ErrorConstants.ERR_RESOURCE_NOT_FOUND, ex.getMessage());
        return new ResponseEntity<>(errorDTO, HttpStatus.BAD_REQUEST);
    }
    ...
    @ResponseBody
    public ResponseEntity<ErrorDTO> processResourceNotFoundException(UnableDeleteException ex) {
        log.error("Error: ", ex);
        ErrorDTO errorDTO = new ErrorDTO(ErrorConstants.ERR_RESOURCE_NOT_FOUND, ex.getMessage());
        return new ResponseEntity<>(errorDTO, HttpStatus.BAD_REQUEST);
    }
